...
DEFINE_GUID(GUID_WaveTransformVertexShaderV,
	0x65fa2492, 0x9478, 0x4c4d, 0x55, 0x67, 0xf6, 0x96, 0x72, 0x6a, 0x43, 0xa4
);
DEFINE_GUID(GUID_WaveTransformVertexBufferV,
	0xa9149e76, 0xc708, 0x4b3a, 0xad, 0x58, 0x56, 0x72, 0x3b, 0x35, 0x33, 0x44
);
DEFINE_GUID(CLSID_CustomWaveEffectV,
	0x7b4c948b, 0xfcf2, 0x4c6b, 0xa0, 0x93, 0xdb, 0x4e, 0x59, 0x99, 0x42, 0x44
);
...
enum VSCROLL_PROP
{
	...
	VWAVE_PROP_SKEW_Y = 4,
	VWAVE_PROP_XRATIO = 5,
	VWAVE_PROP_FORCE_DWORD = 0xFFFFFFFF
};
...
class VScrollEffect : public ID2D1EffectImpl, public ID2D1DrawTransform
{
public:
	...
	HRESULT SetSizeX(float sizex);

	float GetSizeY() const;
	HRESULT SetSizeY(float sizey);
